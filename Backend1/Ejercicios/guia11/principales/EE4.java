...
import guia11.servicios.EE4_Simulador;
...
public class EE4 {
    ...
    siguientes atributos: nombre completo, DNI y cantidad de votos. Además, 
    crearemos una clase Simulador que va a tener los métodos para manejar los 
    alumnos y sus votaciones. Estos métodos serán llamados desde el main.
...
• Se deben crear 5 facilitadores con los 5 primeros alumnos votados y se deben crear
    ...
    */
    ...
    public static void main(String[] args) {
        EE4_Simulador simu = new EE4_Simulador();
