...
*/
public class E4_Rectangulo {
    static Scanner leer = new Scanner(System.in);

    private double base;
    private double altura;

    public E4_Rectangulo() {
    }

    public E4_Rectangulo(double base, double altura) {
        this.base = base;
        this.altura = altura;
    }
    ...
    public static E4_Rectangulo crearRectangulo(){
        double base, altura;
        ...
        return new E4_Rectangulo(base, altura);
    }
